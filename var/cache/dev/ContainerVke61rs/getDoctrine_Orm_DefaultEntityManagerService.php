...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoriaRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\CategoriaRepository']) ? $this->services['App\Repository\CategoriaRepository'] : $this->load('getCategoriaRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\EmpresaRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\EmpresaRepository']) ? $this->services['App\Repository\EmpresaRepository'] : $this->load('getEmpresaRepositoryService.php')) && false ?: '_'};

...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CategoriaType' => function () {
    return ${($_ = isset($this->services['App\Form\CategoriaType']) ? $this->services['App\Form\CategoriaType'] : $this->services['App\Form\CategoriaType'] = new \App\Form\CategoriaType()) && false ?: '_'};
}, 'App\\Form\\EmpresaType' => function () {
    return ${($_ = isset($this->services['App\Form\EmpresaType']) ? $this->services['App\Form\EmpresaType'] : $this->services['App\Form\EmpresaType'] = new \App\Form\EmpresaType()) && false ?: '_'};

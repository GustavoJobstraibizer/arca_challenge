...
// Returns the private 'App\Repository\CategoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoriaRepository.php';

return $this->services['App\Repository\CategoriaRepository'] = new \App\Repository\CategoriaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});

...
// Returns the private 'App\Repository\EmpresaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EmpresaRepository.php';

return $this->services['App\Repository\EmpresaRepository'] = new \App\Repository\EmpresaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
